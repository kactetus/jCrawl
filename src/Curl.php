...
class Curl
{
     ...
     * @var int
     */
    public $pendingRequestsPosition = 0;
     ...
     */
    public $completedRequests = array();
     ...
     */
    public $completedRequestCount = 0;
